...
package body Controller_Help is
   ...
   begin
      Call_OS_CLI("Filer_Run <InsertIcn$Dir>.!Help");
   exception
   ...
   begin
      if StrongHelp.Run then
         case Menu_Entry is
         when 16#0#	=> Call_OS_CLI("stronghelp <InsertIcnRes$Dir>.InsertIcn Intro");
         when 16#1#	=> Call_OS_CLI("stronghelp <InsertIcnRes$Dir>.InsertIcn Install");
         when 16#2#	=> Call_OS_CLI("stronghelp <InsertIcnRes$Dir>.InsertIcn Start");
         when 16#3#	=> Call_OS_CLI("stronghelp <InsertIcnRes$Dir>.InsertIcn Problems");
         when 16#4#	=> Call_OS_CLI("stronghelp <InsertIcnRes$Dir>.InsertIcn Bugz");
         when 16#5#	=> Call_OS_CLI("stronghelp <InsertIcnRes$Dir>.InsertIcn Language");
         when 16#6#	=> Call_OS_CLI("stronghelp <InsertIcnRes$Dir>.InsertIcn History");
         when 16#7#	=> Call_OS_CLI("stronghelp <InsertIcnRes$Dir>.InsertIcn Third");
         when 16#8#	=> Call_OS_CLI("stronghelp <InsertIcnRes$Dir>.InsertIcn Licence");
         when others=> null;
         end case;
      end if;
   exception
